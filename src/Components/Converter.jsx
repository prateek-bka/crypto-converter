    ...
    <>
      <div className="converter-container">
        <Card
          ...
          title={<h1>Crypto Currency Converter</h1>}
        >
          <Form size="large">
            <Form.Item>
              <Input
                style={{ width: "100%" }}
                placeholder="Enter the Crypto Value"
                onChange={(e) => setInputValue(e.target.value)}
              />
            </Form.Item>
          </Form>

          <div className="converter-select-box">
            <Select
              style={{
                width: "210px",
              }}
      ...
      <div className="converter-container-bottom">
        <b> Made with ❤️ ☕ by Prateek Agrawal </b>
        <div>
          <a href="https://www.linkedin.com/in/prateekbka/">{linkedinLogo}</a>
          <a href="https://www.github.com/prateek-bka/">{githubLogo}</a>
        </div>
      </div>
    </>
  );
